...
fun squareOf(file: File, rank: Rank): Square {
	return (rank shl 4) + file
}

fun fileOf(square: Square): File {
	return square and 0xF
}

fun rankOf(square: Square): Rank {
	return square ushr 4
}
