...
import static com.fluxchess.pulse.model.Bitboard.remainder;
...
public final class MoveGenerator {
	...
	public MoveList<MoveEntry> getLegalMoves(Position position, int depth, boolean isCheck) {
	...
	public MoveList<MoveEntry> getMoves(Position position, int depth, boolean isCheck) {
		moves.size = 0;
