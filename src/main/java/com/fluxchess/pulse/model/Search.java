...
import static com.fluxchess.pulse.model.MoveList.*;
...
public final class Search implements Runnable {
	...
	public void newDepthSearch(Position position, int searchDepth) {
		reset();
	...
	public void newNodesSearch(Position position, long searchNodes) {
		reset();
	...
	public void newTimeSearch(Position position, long searchTime) {
		reset();
	...
	public void newInfiniteSearch(Position position) {
		reset();

		this.position = position;
	}

	public void newClockSearch(Position position,
	...
	public void newPonderSearch(Position position,
								long whiteTimeLeft, long whiteTimeIncrement, long blackTimeLeft, long blackTimeIncrement, int movesToGo) {
		reset();
	...
	synchronized public void ponderhit() {
		if (running) {
