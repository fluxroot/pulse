...
import static com.fluxchess.pulse.model.Bitboard.next;
import static com.fluxchess.pulse.model.Bitboard.size;
...
public final class Position {
	...
	public final int[] board = new int[Square.VALUES_LENGTH];

	public final long[][] pieces = new long[Color.values.length][PieceType.values.length];

	public final int[] material = new int[Color.values.length];

	public int castlingRights = NOCASTLING;
	public int enPassantSquare = NOSQUARE;
	...
	private static final class Zobrist {
		...
		public static final long[][] board = new long[Piece.values.length][Square.VALUES_LENGTH];
		public static final long[] castlingRights = new long[Castling.VALUES_LENGTH];
		public static final long[] enPassantSquare = new long[Square.VALUES_LENGTH];
		public static final long activeColor = next();
	...
	public void setCastlingRight(int castling) {
