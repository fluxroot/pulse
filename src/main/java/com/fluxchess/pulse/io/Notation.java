...
public final class Notation {
	...
	public static final String STANDARDPOSITION = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1";
	...
	public static Position toPosition(GenericBoard genericBoard) {
	...
	public static GenericBoard toGenericBoard(Position position) {
	...
	public static int toColor(GenericColor genericColor) {
		switch (genericColor) {
			case WHITE:
				return WHITE;
			case BLACK:
	...
	public static GenericColor fromColor(int color) {
		switch (color) {
			case WHITE:
	...
	public static GenericChessman fromPieceType(int piecetype) {
		switch (piecetype) {
			case PAWN:
	...
	public static int toPiece(GenericPiece genericPiece) {
		switch (genericPiece) {
			case WHITEPAWN:
				return WHITE_PAWN;
			case WHITEKNIGHT:
	...
	public static GenericPiece fromPiece(int piece) {
		switch (piece) {
			case WHITE_PAWN:
	...
	public static GenericCastling fromCastlingType(int castlingtype) {
		switch (castlingtype) {
			case KINGSIDE:
	...
	public static int toFile(GenericFile genericFile) {
		switch (genericFile) {
			case Fa:
				return a;
			case Fb:
	...
	public static GenericFile fromFile(int file) {
		switch (file) {
			case a:
	...
	public static int toRank(GenericRank genericRank) {
		switch (genericRank) {
			case R1:
				return r1;
			case R2:
	...
	public static GenericRank fromRank(int rank) {
		switch (rank) {
			case r1:
	...
	public static int toSquare(GenericPosition genericPosition) {
		return toRank(genericPosition.rank) * 16 + toFile(genericPosition.file);
	}

	public static GenericPosition fromSquare(int square) {
